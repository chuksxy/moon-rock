      ...
      public partial class Graph {
            ...
            public class Props {
                  ...
                  public class Builder {
                        ...
                        public static Ref NewProperty(string propertyID, int value) {
                        ...
                        public static Ref NewProperty(string propertyID, float value) {
                        ...
                        public static Ref NewProperty(string propertyID, string value) {
                        ...
                        public static Ref NewProperty(string propertyID, bool value) {
